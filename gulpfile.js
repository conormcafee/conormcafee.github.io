/*!
 * gulp
 * npm install gulp gulp-ruby-sass gulp-autoprefixer gulp-livereload gulp-cssnano jshint gulp-jshint gulp-concat gulp-uglify gulp-notify gulp-rename gulp-cache del gulp-svgmin gulp-inline-source gulp-imagemin --save-dev
 */
...
gulp.task('sass', function() {
    return sass('build/sass/style.scss', { style: 'expanded' })
